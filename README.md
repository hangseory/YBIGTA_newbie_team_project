...
카카오맵, 구글맵, 트립어드바이저의 월별 리뷰 작성 횟수를 선그래프로 비교

<!-- 월별 리뷰 수 그래프 완성 후 분석 내용 작성 -->

### 3.3 사이트별 주요 키워드 등장 횟수 비교

![사이트별 키워드 등장 횟수 비교](review_analysis/plots/keyword_comparison.png)

각 사이트의 리뷰에서 주요 키워드를 추출한 후, 사이트별 키워드 등장 횟수를 비교

<!-- 키워드 비교 그래프 완성 후 분석 내용 작성 -->
